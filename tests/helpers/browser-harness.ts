...
const SHARED_RUNTIME_FILES = [
  ...
  "src/combat/combat-weapon-scaling.js",
  "src/combat/combat-engine-minions.js",
  "src/combat/combat-engine-weapon-effects.js",
  "src/combat/combat-engine-damage.js",
  "src/combat/combat-engine-minion-actions.js",
  "src/combat/combat-engine-enemy-turns.js",
...
const ENCOUNTER_REGISTRY_HELPER_FILES = [
  ...
  "src/content/encounter-registry-builders-recipes.js",
...
const ITEM_RUNTIME_FILES = [
  ...
  "src/items/item-catalog-profile-data.js",
  "src/items/item-catalog-profiles.js",
  "src/items/item-catalog-runtime-content.js",
  ...
  "src/items/item-town-deck-services-shared.js",
  "src/items/item-town-deck-services-blacksmith.js",
  "src/items/item-town-deck-services-sage.js",
  "src/items/item-town-deck-services-gambler.js",
...
const APP_UI_RUNTIME_FILES = [
  ...
  "src/ui/character-select-view-details.js",
  "src/ui/character-select-view.js",
  "src/ui/safe-zone-operations-view-model.js",
...
const WORLD_NODE_RUNTIME_FILES = [
  ...
  "src/quests/world-node-engine-choice-strategy.js",
  "src/quests/world-node-engine-runeforge.js",
  "src/quests/world-node-engine-opportunity-resolvers.js",
...
const APP_RUNTIME_FILES = [
  ...
  "src/rewards/reward-engine-archetypes-data.js",
  "src/rewards/reward-engine-card-classification.js",
  "src/rewards/reward-engine-archetypes-policy.js",
