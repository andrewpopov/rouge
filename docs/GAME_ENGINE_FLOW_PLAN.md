...
- broader account-level unlock trees and profile UX beyond the current hall navigator, hall decision desk, prep-drilldown shell, route or reward or transition continuity shell, and account ownership seam
