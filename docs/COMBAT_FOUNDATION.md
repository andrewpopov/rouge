...
- consequence-conditioned branch and boss encounter packages plus branch or miniboss or boss combat reward packages that swap in route-specific recovery, accord, and covenant fight variants or payouts when those world flags resolve
