...
- authored mercenary route perks can turn world-node flags into compound crossroad-to-reserve-to-relay-to-culmination packages with parallel legacy and reckoning combat payoffs, including opening Guard, hero Guard, flat attack, hero damage, behavior-specific bonuses, and opening draw
...
- broader generated act pools with seven opening encounters, five branch battles, five branch minibosses, four elite-affix families per act, and stronger escort, support-screen, sniper-nest, and phalanx-front encounter scripting
- encounter-local modifiers for fortified starts, ambush openings, backline screens, vanguard rushes, escort bulwarks, escort commands, crossfire lanes, war drums, triage commands, triage screens, elite onslaughts, sniper nests, and phalanx marches
...
- broader encounter-local modifier catalogs and escort or boss scripting beyond the current thirteen-modifier, sniper-nest, and phalanx-march baseline
