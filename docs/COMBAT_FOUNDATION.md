...
- broader generated act pools with seven opening encounters, five branch battles, five branch minibosses, four elite-affix families per act, and stronger escort, backline-screen, boss-screen, sniper-nest, and phalanx-march encounter scripting
- encounter-local modifiers for fortified starts, ambush openings, backline screens, vanguard rushes, escort bulwarks, escort commands, crossfire lanes, war drums, triage commands, triage screens, elite onslaughts, sniper nests, boss screens, and phalanx marches
...
- broader encounter-local modifier catalogs and escort or boss scripting beyond the current fourteen-modifier, boss-screen, sniper-nest, and phalanx-march baseline
