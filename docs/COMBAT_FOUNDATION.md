...
- consequence-conditioned branch and boss encounter packages that swap in route-specific recovery, accord, and covenant fight variants when those world flags resolve
