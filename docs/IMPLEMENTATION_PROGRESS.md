...
- compiled browser tests passing: `154`
...
- profile settings, account-tree focus controls, progression summaries, shell-facing focused-tree review plus tutorial-or-settings-or-planning control panels, and front-door archive-review navigation over stored run history
...
- preferred-class control and runeword-planning controls from the front door plus carry-through into character select or town economy summaries
...
6. continue tuning late-run replacement pressure, account-gated reward variety, and long-horizon stash or vendor economy pressure beyond the current higher-tier item, rune, and runeword band plus the current treasury-exchange consignment sink and current runeword-planning charters
