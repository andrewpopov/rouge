...
- compiled browser tests passing: `169`
...
- a hall decision desk, town prep comparison board, and run-end hall handoff that compare archive delta, convergence pressure, charter pressure, live account bonuses, and next-action guidance
- character select
- app engine
- run creation
...
Remaining:
- broader map or reward continuity and richer account-level meta continuity beyond the current hall or town or run-end decision-support shell
...
- broader late-run mercenary payoff only if future route families create new contract-side seams beyond the current covenant-or-detour-or-escalation-linked perk pass
