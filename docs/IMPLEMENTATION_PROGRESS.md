...
- compiled browser tests passing: `148`
...
- profile settings, account-tree focus controls, progression summaries, shell-facing focused-tree review plus tutorial-or-settings control panels, and front-door archive-review navigation over stored run history
...
- preferred-class control from the front door plus carry-through into character select
...
2. grow the live archive or economy or mastery trees into broader capstone-style account systems, stronger account review data, and longer-horizon economy sinks on top of the current focus or settings or tutorial seams
...
5. broaden the encounter-local modifier catalog and escort or boss scripting beyond the current thirteen-modifier combat baseline
6. continue tuning late-run replacement pressure, account-gated reward variety, and long-horizon stash or vendor economy pressure beyond the current higher-tier item, rune, and runeword band plus the current treasury-exchange consignment sink
