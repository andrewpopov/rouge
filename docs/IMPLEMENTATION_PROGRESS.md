...
- a hall decision desk, town prep comparison board, world-map route decision desk, reward continuity desk, act delta review wrapper, run-end hall handoff, and shared account-meta continuity board that compare archive delta, convergence pressure, charter pressure, mastery pressure, live account bonuses, shell handoff, and next-action guidance
- character select
- app engine
- run creation
...
Remaining:
- broader account-level controls and richer charter or convergence drilldowns beyond the current hall or town or map or reward or act-transition or run-end continuity and decision-support shell
