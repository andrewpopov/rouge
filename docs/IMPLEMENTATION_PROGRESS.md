...
- a hall decision desk, town prep comparison board, world-map route decision desk, reward continuity desk, act delta review wrapper, and run-end hall handoff that compare archive delta, convergence pressure, charter pressure, live account bonuses, shell handoff, and next-action guidance
- character select
- app engine
- run creation
...
Remaining:
- richer shared account-meta continuity and broader account-level controls beyond the current hall or town or map or reward or act-transition or run-end decision-support shell
