...
- broader account-level unlock trees and broader account UX beyond the current archive or economy or mastery trees, the current imperial-annals or trade-hegemony or mythic-doctrine third wave, current capstone or convergence review, navigable account hall, expedition launch runway, town drilldowns, route-intel shell, preferred-class or settings or tutorial or runeword-planning controls, charter-ledger review, interactive archive-review desk, the current shared account-meta continuity board, the current shared charter or convergence drilldown layer, and the current hall or town or map or reward or act-transition or run-end decision-support layer
