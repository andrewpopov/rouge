(() => {
  ...
  const NECROMANCER_CARDS: Record<string, ClassCardDefinition> = {
    ...
    necromancer_poison_dagger: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 5 poison damage. Apply 3 Poison.",
      effects: [
        { kind: "damage", value: 5 },
    ...
    necromancer_skeletal_mage: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 6 damage. Apply 3 Poison. Mercenary next attack +3.",
      effects: [
        { kind: "damage", value: 6 },
        { kind: "apply_poison", value: 3 },
        { kind: "buff_mercenary_next_attack", value: 3 },
    ...
    necromancer_poison_nova: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 7 poison damage to all enemies. Apply 4 Poison to all.",
      effects: [
