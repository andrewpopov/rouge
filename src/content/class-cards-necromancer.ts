(() => {
  ...
  const NECROMANCER_CARDS: Record<string, ClassCardDefinition> = {
    ...
    necromancer_raise_skeleton: {
      ...
      cost: 1,
      target: "none",
      text: "Summon Skeleton. Each ally phase it slashes for 4.",
      effects: [
    ...
    necromancer_clay_golem: {
      ...
      cost: 1,
      target: "none",
      text: "Gain 4 Guard. Summon Clay Golem. Each ally phase it hits for 5 and grants 4 Guard to the party.",
      effects: [
        { kind: "gain_guard_self", value: 4 },
        { kind: "summon_minion", value: 5, secondaryValue: 4, minionId: "necromancer_clay_golem" },
      ],
      behaviorTags: ["setup", "scaling", "protection", "mitigation"],
      roleTag: "support",
      rewardRole: "support",
    ...
    necromancer_skeletal_mage: {
      ...
      behaviorTags: ["setup", "scaling", "pressure", "payoff"],
      roleTag: "payoff",
      rewardRole: "engine",
  ...
  const NECROMANCER_STARTER_DECK = [
    "necromancer_teeth", "necromancer_teeth",
