(() => {
  ...
  const NECROMANCER_CARDS: Record<string, ClassCardDefinition> = {
    ...
    necromancer_decrepify: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 10 damage. Your mercenary deals +12 to this target. Gain 5 Guard. Draw 1 card.",
      effects: [
    ...
    necromancer_skeletal_mage: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 9 damage. Apply 4 Poison. Mercenary next attack +5.",
      effects: [
        { kind: "damage", value: 9 },
        { kind: "apply_poison", value: 4 },
    ...
    necromancer_bone_spirit: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 22 magic damage. Gain 5 Guard. Draw 1 card.",
      effects: [
    ...
    necromancer_revive: {
      ...
      cost: 2,
      target: "none",
      text: "Heal 8. Heal your mercenary 12. You and your mercenary gain 14 Guard. Mercenary next attack +8.",
      effects: [
