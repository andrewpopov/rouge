(() => {
  ...
  const ASSASSIN_CARDS: Record<string, ClassCardDefinition> = {
    ...
    assassin_wake_of_fire: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 5 fire damage to all enemies. Apply 3 Burn to all. Gain 3 Guard.",
      effects: [
    ...
    assassin_fade: {
      ...
      cost: 1,
      target: "none",
      text: "You and your mercenary gain 16 Guard.",
      effects: [{ kind: "gain_guard_party", value: 16 }],
    ...
    assassin_lightning_sentry: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 lightning damage to all enemies. Apply 1 Paralyze to all. Gain 4 Guard.",
      effects: [
    ...
    assassin_shadow_warrior: {
      ...
      cost: 1,
      target: "none",
      text: "You and your mercenary gain 6 Guard. Heal your mercenary 10. Mercenary next attack +8.",
      effects: [
    ...
    assassin_death_sentry: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 13 lightning damage to all enemies. Apply 2 Paralyze to all. Gain 7 Guard.",
      effects: [
