(() => {
  ...
  const SORCERESS_CARDS: Record<string, ClassCardDefinition> = {
    ...
    sorceress_frost_nova: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 6 cold damage to all enemies. Apply 1 Freeze to all. Gain 5 Guard.",
      effects: [
    ...
    sorceress_static_field: {
      ...
      behaviorTags: ["pressure", "setup", "salvage", "payoff"],
      roleTag: "setup",
      rewardRole: "engine",
    ...
    sorceress_blizzard: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 cold damage to all enemies. Apply 1 Freeze to all. Gain 6 Guard.",
      effects: [
    ...
    sorceress_meteor: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 10 fire damage to all enemies. Apply 3 Burn to all.",
      effects: [
    ...
    sorceress_frozen_orb: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 10 cold damage to all enemies. Apply 2 Freeze to all. Gain 8 Guard.",
      effects: [
        { kind: "damage_all", value: 10 },
    ...
    sorceress_hydra: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 11 fire damage to all enemies. Apply 8 Burn to all. Gain 6 Guard.",
      effects: [
    ...
    sorceress_lightning_mastery: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 12 lightning damage to all enemies. Apply 2 Paralyze to all. Gain 5 Guard. Draw 1 card.",
      effects: [
