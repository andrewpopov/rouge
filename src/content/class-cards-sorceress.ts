(() => {
  ...
  const SORCERESS_CARDS: Record<string, ClassCardDefinition> = {
    ...
    sorceress_frost_nova: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 5 cold damage to all enemies. Apply 1 Freeze to all. Gain 3 Guard.",
      effects: [
    ...
    sorceress_static_field: {
      ...
      cost: 1,
      target: "none",
      text: "Deal 4 lightning damage to all enemies. Apply 1 Paralyze to all. Draw 1 card.",
      effects: [
    ...
    sorceress_blizzard: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 7 cold damage to all enemies. Apply 1 Freeze to all. Gain 4 Guard.",
      effects: [
    ...
    sorceress_meteor: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 fire damage to all enemies. Apply 2 Burn to all.",
      effects: [
    ...
    sorceress_chain_lightning: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 lightning damage to all enemies. Apply 1 Paralyze to all. Draw 1 card.",
      effects: [
        { kind: "damage_all", value: 8 },
        { kind: "apply_paralyze_all", value: 1 },
        { kind: "draw", value: 1 },
    ...
    sorceress_frozen_orb: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 9 cold damage to all enemies. Apply 2 Freeze to all. Gain 5 Guard.",
      effects: [
    ...
    sorceress_hydra: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 9 fire damage to all enemies. Apply 6 Burn to all. Gain 5 Guard.",
      effects: [
        { kind: "damage_all", value: 9 },
    ...
    sorceress_lightning_mastery: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 11 lightning damage to all enemies. Apply 2 Paralyze to all. Gain 4 Guard. Draw 1 card.",
      effects: [
