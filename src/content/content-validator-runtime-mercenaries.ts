(() => {
  ...
  const MIN_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_COMPOUND_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_SCALING_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_RESERVE_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_RELAY_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_CULMINATION_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_LEGACY_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_RECKONING_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_RECOVERY_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_ACCORD_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
  const MIN_COVENANT_LINKED_ROUTE_PERKS_PER_MERCENARY = 0;
