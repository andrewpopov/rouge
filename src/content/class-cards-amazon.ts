(() => {
  ...
  const AMAZON_CARDS: Record<string, ClassCardDefinition> = {
    ...
    amazon_magic_arrow: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 8 magic damage. Ignores guard.",
    ...
    amazon_inner_sight: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 4 damage. Your mercenary deals +6 to this target.",
      effects: [
        { kind: "damage", value: 4 },
    ...
    amazon_power_strike: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 9 lightning damage. Apply 1 Paralyze.",
      effects: [
        { kind: "damage", value: 9 },
    ...
    amazon_guided_arrow: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 13 damage. Draw 1 card.",
      effects: [
    ...
    amazon_charged_strike: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 10 lightning damage. Deal 9 lightning damage. Apply 2 Paralyze. Gain 5 Guard.",
      effects: [
    ...
    amazon_valkyrie: {
      ...
      cost: 2,
      target: "none",
      text: "You and your mercenary gain 12 Guard. Mercenary next attack +6.",
      effects: [
    ...
    amazon_freezing_arrow: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 cold damage to all enemies. Apply 1 Freeze and 1 Slow to all.",
      effects: [
        { kind: "damage_all", value: 8 },
    ...
    amazon_lightning_fury: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 9 lightning damage to all enemies. Apply 2 Paralyze to all.",
      effects: [
