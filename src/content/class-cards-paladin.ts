(() => {
  ...
  const PALADIN_CARDS: Record<string, ClassCardDefinition> = {
    ...
    paladin_smite: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 6 damage. Gain 3 Guard.",
      effects: [
        { kind: "damage", value: 6 },
    ...
    paladin_zeal: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 5 damage. Deal 4 damage. Deal 3 damage. Gain 4 Guard.",
      effects: [
        { kind: "damage", value: 5 },
        { kind: "damage", value: 4 },
        { kind: "damage", value: 3 },
    ...
    paladin_holy_shield: {
      ...
      cost: 1,
      target: "none",
      text: "Gain 15 Guard. Draw 2 cards.",
      effects: [
    ...
    paladin_fist_of_the_heavens: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 18 magic damage. Heal 8. Gain 4 Guard.",
      effects: [
