(() => {
  ...
  const BARBARIAN_CARDS: Record<string, ClassCardDefinition> = {
    ...
    barbarian_whirlwind: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 12 damage to all enemies. Gain 6 Guard.",
      effects: [
    ...
    barbarian_berserk: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 22 magic damage. Gain 10 Guard.",
      effects: [
    ...
    barbarian_war_cry: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 damage to all enemies. You and your mercenary gain 12 Guard.",
      effects: [
