(() => {
  ...
  const BARBARIAN_CARDS: Record<string, ClassCardDefinition> = {
    ...
    barbarian_concentrate: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 12 damage. Gain 8 Guard.",
      effects: [
    ...
    barbarian_frenzy: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 9 damage. Deal 8 damage. Draw 1 card.",
      effects: [
        { kind: "damage", value: 9 },
        { kind: "damage", value: 8 },
        { kind: "draw", value: 1 },
    ...
    barbarian_berserk: {
      ...
      cost: 2,
      target: "enemy",
      text: "Deal 22 magic damage. Gain 8 Guard.",
      effects: [
    ...
    barbarian_war_cry: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 8 damage to all enemies. You and your mercenary gain 10 Guard.",
      effects: [
