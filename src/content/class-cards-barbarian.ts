(() => {
  ...
  const BARBARIAN_CARDS: Record<string, ClassCardDefinition> = {
    ...
    barbarian_shout: {
      ...
      cost: 1,
      target: "none",
      text: "You and your mercenary gain 10 Guard. Draw 1 card.",
      effects: [
    ...
    barbarian_concentrate: {
      ...
      cost: 1,
      target: "enemy",
      text: "Deal 12 damage. Gain 10 Guard.",
      effects: [
    ...
    barbarian_battle_orders: {
      ...
      cost: 2,
      target: "none",
      text: "You and your mercenary gain 22 Guard. Mercenary next attack +16.",
      effects: [
    ...
    barbarian_whirlwind: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 15 damage to all enemies. Gain 10 Guard.",
      effects: [
    ...
    barbarian_war_cry: {
      ...
      cost: 2,
      target: "none",
      text: "Deal 14 damage to all enemies. Apply 1 Stun to all. You and your mercenary gain 22 Guard.",
      effects: [
