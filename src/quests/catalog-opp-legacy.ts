(() => {
  ...
  const LEGACY_OPPORTUNITY_DEFINITIONS: Record<number, LegacyOpportunityDefinition> = {
    ...
    3: {
      ...
      description: "After the final harbor approach resolves, the dockside wake can still be tuned into one lasting Idol Reach posture.",
      ...
      variants: [
        {
          ...
          choices: [
            legacyChoice(
              ...
              "Turn the last harbor push into a reserve stack over the Sanctum approach.",
            ...
            legacyChoice(
              ...
              "Use the same route to close out the last signal net across the Idol Reach docks.",
        ...
        },
        {
          ...
          title: "Sanctum Channel Legacy",
          description: "A cleared Sanctum channel turns the legacy lane into a true river command instead of a generic dock reserve.",
          ...
          choices: [
            legacyChoice(
              ...
              "Carry the cleared channel into one last river command over the Sanctum mouth.",
            ...
            legacyChoice(
              ...
              "Use the same cleaned channel to bury the last oil runs before the Sanctum closes.",
    ...
    5: {
      ...
      description: "After the final ascent resolves, the Frosthaven rescue can still be tuned into one lasting summit posture.",
