(() => {
  ...
  const DETOUR_OPPORTUNITY_DEFINITIONS: Record<number, DetourOpportunityDefinition> = {
    ...
    3: {
      ...
      description: "After the harbor covenant closes, Idol Reach can still peel into a quieter river detour that banks recovery work instead of running straight at the Sanctum.",
      ...
      variants: [
        ...
        buildLateRouteVariant(buildDetourChoice, "kurast_detour_opportunity", "smugglers_wake", {
          ...
          choice: {
            ...
            description: "Turn the spellward bins and channel marks into a guarded sidepass around the next Idol Reach clash.",
        ...
        buildLateRouteVariant(buildDetourChoice, "kurast_detour_opportunity", "smugglers_wake", {
          ...
          choice: {
            ...
            description: "Move the covenant ledger, spellward bins, and channel marks into one hidden fleet around the next Sanctum push.",
    ...
    5: {
      ...
      description: "After the summit covenant closes, Frosthaven can still break into a guarded sled detour that circles the last ascent instead of driving straight at the Ruin Crown.",
      ...
      variants: [
        buildLateRouteVariant(buildDetourChoice, "harrogath_detour_opportunity", "harrogath_rescue", {
          id: "summit_detour",
          title: "Sled Detour",
          description: "Even without a sharper summit line, Frosthaven can still open one last sled detour around the frozen climb.",
          summary: "A fallback detour opens after the covenant resolves.",
          grants: { gold: 6, xp: 8, potions: 0 },
          choice: {
        ...
        buildLateRouteVariant(buildDetourChoice, "harrogath_detour_opportunity", "harrogath_rescue", {
          ...
          summary: "A full summit late-route close can now turn into a protected sled detour instead of another straight Ruin Crown rush.",
          grants: { gold: 8, xp: 8, potions: 0 },
          ...
          choice: {
            ...
            description: "Move the covenant ledger, guard banners, and Ancients posts into one hidden sled chain before the next Ruin Crown push.",
