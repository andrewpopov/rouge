(() => {
  ...
  const RELAY_OPPORTUNITY_DEFINITIONS: Record<number, RelayOpportunityDefinition> = {
    2: {
      ...
      description: "Once the desert reserve settles, one last relay column can push that work through the the Sepulcher Devourer crossing.",
    ...
    3: {
      ...
      description: "Once the hidden harbor reserve settles, one last relay lane can carry that work into the Sanctum approach.",
