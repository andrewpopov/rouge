(() => {
  ...
  const ZONE_ENV_MAP: Record<string, ZoneEnv> = {
    ...
    "den of evil": "cave",
    "cold plains": "plains",
    "burial grounds": "ruins",
    "stony field": "plains",
    "underground passage": "cave",
    "dark wood": "forest",
    "tristram": "ruins",
    "black marsh": "marsh",
    "forgotten tower": "ruins",
    "tamoe highland": "monastery",
    "outer cloister": "monastery",
    "barracks": "monastery",
    "jail": "cave",
    ...
    "dry hills": "desert",
    "sewers": "cave",
    "halls of the dead": "tomb",
    "far oasis": "oasis",
    "lost city": "ruins",
    "maggot lair": "cave",
    "valley of snakes": "canyon",
    "harem": "temple",
    "palace cellar": "cave",
    "arcane sanctuary": "temple",
    "canyon of the magi": "canyon",
    "tal rasha": "tomb",
    // Act 3
    "spider forest": "jungle",
    "spider cavern": "cave",
    "great marsh": "jungle",
    "flayer jungle": "jungle",
    "flayer dungeon": "cave",
    "lower kurast": "jungle",
    "kurast bazaar": "temple",
    "upper kurast": "temple",
    "kurast causeway": "temple",
    "kurast sewers": "cave",
    "travincal": "temple",
    "durance of hate": "hell",
    // Act 4
    "outer steppes": "hell",
    "plains of despair": "hell",
    "city of the damned": "hell",
    "river of flame": "hell",
    "chaos sanctuary": "hell",
    // Act 5
    "bloody foothills": "mountain",
    "frigid highlands": "ice",
    "arreat plateau": "mountain",
    "crystalline passage": "ice",
    "glacial trail": "ice",
    "frozen tundra": "ice",
    "frozen river": "ice",
    "nihlathak": "ice",
    ...
    "infernal pit": "hell",
    "ancient": "mountain",
    "arreat summit": "mountain",
    "worldstone keep": "mountain",
