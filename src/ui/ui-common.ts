(() => {
  ...
  runtimeWindow.ROUGE_UI_COMMON = {
    ...
    createDefaultArchiveSummary: (...args) => getAccountMeta().createDefaultArchiveSummary(...args),
    createDefaultStashSummary: (...args) => getAccountMeta().createDefaultStashSummary(...args),
    createDefaultReviewSummary: () => getAccountMeta().createDefaultReviewSummary(),
