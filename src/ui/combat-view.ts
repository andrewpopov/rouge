        ...
        <div class="stage" data-env="${zoneEnv}">
          ...
          <div class="stage__allies">
            ${renderAllySprite(
              ...
              combat.potions <= 0 || combat.hero.life >= combat.hero.maxLife || hasOutcome, escapeHtml
            )}
            ${renderAllySprite(
              combat.mercenary, "sprite__figure--merc", mercPortrait, "use-potion-mercenary",
              combat.potions <= 0 || !combat.mercenary.alive || combat.mercenary.life >= combat.mercenary.maxLife || hasOutcome, escapeHtml
            )}
          </div>
