(() => {
  ...
  const ITEM_TEMPLATES = {
    ...
    item_gorgon_crossbow: {
      sourceId: "gorgon_crossbow",
      slot: "weapon",
      family: "Crossbows",
      actRequirement: 5,
      progressionTier: 8,
    ...
    item_hyperion_javelin: {
      sourceId: "hyperion_javelin",
      slot: "weapon",
      family: "Javelins",
      actRequirement: 5,
      progressionTier: 7,
  ...
  const ACCESSORY_TEMPLATES = runtimeWindow.__ROUGE_ITEM_DATA_ACCESSORIES || {};
  const MERGED_TEMPLATES = { ...ITEM_TEMPLATES, ...ACCESSORY_TEMPLATES };

  runtimeWindow.ROUGE_ITEM_DATA = {
    ITEM_TEMPLATES: MERGED_TEMPLATES,
    RUNE_TEMPLATES,
    RUNEWORD_TEMPLATES,
    RUNE_REWARD_POOLS,
  };
